...
\includepdfmerge[fitpaper=true,rotateoversize=true]{TOC.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{acknowledgements.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{notation.pdf,-}
\renewcommand{\thepage}{\arabic{page}}\setcounter{page}{1}
\includepdfmerge[fitpaper=true,rotateoversize=true]{intro.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{part_basics.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{linear_algebra.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{prob.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{numerical.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{ml.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{part_practical.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{mlp.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{regularization.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{optimization.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{convnets.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{rnn.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{guidelines.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{applications.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{part_research.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{linear_factors.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{autoencoders.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{representation.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{graphical_models.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{monte_carlo.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{partition.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{inference.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{generative_models.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{bib.pdf,-}
\includepdfmerge[fitpaper=true,rotateoversize=true]{index-.pdf,-}
