...
![:pdf 75%,center](generalization_error.pdf)
...
the same _overall_ error when processing unseen examples _without advance knowledge_.
In a sense, no machine
learning algorithm is _universally_ better than any other.
That is, improvement of **performance** in problem-solving **depends on using
prior information** to match procedures to problems.
