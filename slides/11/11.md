...
![w=80%,h=center](albert_configurations.svgz)
...
![w=80%,h=center](albert_ablations_vocabulary_embedding.svgz)
...
![w=80%,h=center,mh=80%,v=middle](albert_ablations_sharing.svgz)
...
![w=80%,h=center,mh=80%,v=middle](albert_ablations_sop.svgz)

---
# ALBERT Results and Ablations

![w=85%,h=center](albert_results.svgz)

~~~
![w=85%,h=center](albert_ablations_data.svgz)

~~~
![w=85%,h=center](albert_ablations_dropout.svgz)

---
# ALBERT SoTA Results
![w=100%](albert_results_glue.svgz)

---
# ALBERT SoTA Results
![w=100%](albert_results_squad_race.svgz)
