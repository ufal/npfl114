...
The _pre-activaion_ architecture was evaluated also on ImageNet, in a single-crop
regime.
...
~~~
In order to come up with _upscaling convoluion_, we start by considering how
