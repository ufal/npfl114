...
- learning rate starts with 0.1 and is divided by 10 when error plateaus
  - 60k training iterations (steps) are used
  - in one graph in the paper, they decay at 25% and 50% of the training
    - other concurrent papers also use exponential decay, 33%-66%, or 50-75%
