...
$$(⇉K * ⇉I)_{i, j} = ∑\nolimits_{m, n} ⇉I_{i-m, k-n} ⇉K_{m, n}.$$
...
![w=95%,h=center](deep_prior_network.pdf)
...
without increasing overfitting. Similarly, L2 regularization can be reduced
by a factor of 5.
...
~~~
- Small L2 regularization (1e-4) is still useful for convolutional kernels.
