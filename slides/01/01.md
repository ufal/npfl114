...
![w=80%,h=center](relu_approx-0.svg)

~~~ ~
# Evolving ReLU Approximation
![w=80%,h=center](relu_approx-1.svg)

~~~ ~
# Evolving ReLU Approximation
![w=80%,h=center](relu_approx-2.svg)

~~~ ~
# Evolving ReLU Approximation
![w=80%,h=center](relu_approx-3.svg)

~~~ ~
# Evolving ReLU Approximation
![w=80%,h=center](relu_approx-4.svg)
