...
- **BPE**:
  ...
  a special end-of-word symbol $\cdot$. Then, merge the most occurring symbol pair
...
is used during training, with the learning rate descreasing proportionally to
