...
parser.add_argument("--rnn", default="LSTM", choices=["LSTM", "GRU", "SimpleRNN"], help="RNN cell type.")
parser.add_argument("--rnn_dim", default=10, type=int, help="RNN cell dimension.")
