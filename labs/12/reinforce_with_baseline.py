    ...
    while True:
        ...
        for _ in range(args.batch_size):
            ...
            while not done:
                ...
                # TODO(reinforce): Update states, actions and rewards
