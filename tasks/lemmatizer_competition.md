...
Czech PDT dataset loadable using the [morpho_dataset.py](https://github.com/ufal/npfl114/tree/past-2122/labs/09/morpho_dataset.py)
module.
...
[lemmatizer_competition.py](https://github.com/ufal/npfl114/tree/past-2122/labs/09/lemmatizer_competition.py)
template, which among others generates test set annotations in the required format. Note that
you can evaluate the predictions as usual using the [morpho_dataset.py](https://github.com/ufal/npfl114/tree/past-2122/labs/09/morpho_dataset.py)
